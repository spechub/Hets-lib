...
Axiom \isa{{\isachardoublequote}determ{\isachardoublequote}} is the typical relationship between \isa{{\isasymlangle}p{\isasymrangle}P} and \isa{{\isacharbrackleft}{\isacharhash}\ p{\isacharbrackright}P} 
  when no nondeterminism is involved. Axioms \isa{{\isachardoublequote}altB{\isacharunderscore}iff{\isachardoublequote}\ {\isachardoublequote}altD{\isacharunderscore}iff{\isachardoublequote}} describe the 
