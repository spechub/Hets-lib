theory SWCommonPatterns_SolidWorksCylByArcExtrusion_is_AbstractCylinder
...
ML "Header.initialize
    [\"inv_Group\", \"rinv_Group\", \"distr1_Ring\", \"distr2_Ring\",
     ...
     \"def_of_Circle\", \"def_of_Cylinder\", \"def_of_Cylinder1\",
     ...
     \"semantics_for_SWPoint\", \"semantics_for_SWVector\",
     \"semantics_for_Planes\", \"semantics_for_ArcExtrusion\",
     \"help4\", \"help5\", \"help6\", \"help7\", \"def_of_given_arc\",
...
X_SWExtrusion2 :: "SWSketch => Real => Real => Real => Real => SWExtrusion" ("SWExtrusion2/'(_,/ _,/ _,/ _,/ _')" [3,3,3,3,3] 999)
...
using Ax1_1 Ax2 sqr_def sqrt_def X2_def_Real X3_def_Real
      ...
      plus_PointSet_VectorSet def_of_Circle def_of_Cylinder
